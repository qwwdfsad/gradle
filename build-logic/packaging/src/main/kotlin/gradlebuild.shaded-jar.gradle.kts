...
fun addShadedJarTask(): TaskProvider<ShadedJar> {
    ...
    // Reuse the pom.properties generated by the org.gradle.pom-properties plugin for the module,
    // whose artifactId is already the module base name (e.g. gradle-tooling-api).
    val pomPropertiesTask = tasks.named<GeneratePomProperties>("generatePomProperties")
    ...
    return tasks.register("${project.name.kebabToCamel()}ShadedJar", ShadedJar::class) {
        ...
        pomProperties.from(pomPropertiesTask)
    }
}
