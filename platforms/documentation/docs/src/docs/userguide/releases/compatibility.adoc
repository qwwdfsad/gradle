...
The Gradle wrapper, Gradle client, Tooling API client, and TestKit client require JVM 11 or later.

JDK 6 and above can be used for <<building_java_projects.adoc#sec:java_cross_compilation,compilation>>.
JVM 11 and above can be used for executing tests and worker processes.
